...
ELSE (APPLE)
	...
	IF (WIN32)
	    ...
	    IF("${ISWIN64}" STREQUAL "Win64") 
			IF(IS_DIRECTORY $ENV{ATISTREAMSDKROOT})
				SET(OPENCL_LIB_DIR "$ENV{ATISTREAMSDKROOT}/lib/x86_64")
			ELSEIF(IS_DIRECTORY $ENV{AMDAPPSDKROOT})
				SET(OPENCL_LIB_DIR "$ENV{AMDAPPSDKROOT}/lib/x86_64")
			ELSEIF(IS_DIRECTORY $ENV{INTELOCLSDKROOT})
				SET(OPENCL_LIB_DIR "$ENV{INTELOCLSDKROOT}/lib/x64")
			ENDIF(IS_DIRECTORY $ENV{ATISTREAMSDKROOT})
